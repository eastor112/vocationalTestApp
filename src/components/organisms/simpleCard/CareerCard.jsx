    ...
    <div className='flex flex-col items-center bg-white rounded-md border shadow-md hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 overflow-hidden'>
      <div className='flex flex-col justify-between p-4 leading-normal'>
        ...
        <div className='flex gap-2 mt-4'>
          <button type='button' className='w-20 flex items-center justify-center text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-md text-sm px-2 py-1.5 text-center mr-1'>
          ...
          <button type='button' className='w-20 flex items-center justify-center text-gray-900 bg-gradient-to-r from-yellow-200 via-yellow-250 to-yellow-300 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-yellow-250 dark:focus:ring-lime-800 font-medium rounded-md text-sm px-2 py-1.5 text-center mr-1'>
            <svg xmlns='http://www.w3.org/2000/svg' className='h-3.5 w-3.5 mr-1' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth='2'>
          ...
          <button type='button' className='w-20 flex items-center justify-center text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-md text-sm px-2 py-1.5 text-center mr-1'>
            <svg xmlns='http://www.w3.org/2000/svg' className='h-3.5 w-3.5 mr-1' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth='2'>
