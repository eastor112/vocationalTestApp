      ...
      <div className='p-5 flex flex-col items-center'>
        {
          ...
          && (
            <Link
              ...
              className='take-test-button focus:outline-none text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 '
            >
              Start the test
            </Link>
          )
        }
        {
          ...
          && (
            <button
              type='button'
              className='buy-button text-white bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-md text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:focus:ring-yellow-900'
