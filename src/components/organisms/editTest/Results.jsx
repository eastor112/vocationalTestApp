      ...
      <div id='accordion-color-body-1' className='hidden' aria-labelledby='accordion-color-heading-1'>
        <div className='p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900'>
          ...
          <p className='text-gray-500 dark:text-gray-400'>
            ...
            {' '}
            <a href='https://flowbite.com/docs/getting-started/introduction/' className='text-blue-600 dark:text-blue-500 hover:underline'>get started</a>
            {' '}
      ...
      <div id='accordion-color-body-2' className='hidden' aria-labelledby='accordion-color-heading-2'>
        <div className='p-5 border border-b-0 border-gray-200 dark:border-gray-700'>
          ...
          <p className='text-gray-500 dark:text-gray-400'>
            Check out the
            {' '}
            <a href='https://flowbite.com/figma/' className='text-blue-600 dark:text-blue-500 hover:underline'>Figma design system</a>
            {' '}
