    ...
    <aside className={"fixed  transition duration-1000 " + (expand ? "w-64" : "w-16")} aria-label="Sidebar">
      <div className="overflow-hidden py-4 px-3 h-screen bg-primary-1 flex flex-col justify-between">
        ...
        <ul className="space-y-2">
          ...
          <li>
            <NavLink to="." className="flex items-center p-2 text-base font-normal text-light-1 rounded-lg  hover:bg-primary-2">
              <svg className="flex-shrink-0 w-6 h-6 text-light-1 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
              <span className={expand ? "flex-1 ml-3 whitespace-nowrap" : "hidden"}>
                Kanban
              </span>
          ...
          <li>
            <NavLink to="." className="flex items-center p-2 text-base font-normal text-light-1 rounded-lg  hover:bg-primary-2">
              <svg className="flex-shrink-0 w-6 h-6 text-light-1 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M8.707 7.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l2-2a1 1 0 00-1.414-1.414L11 7.586V3a1 1 0 10-2 0v4.586l-.293-.293z"></path><path d="M3 5a2 2 0 012-2h1a1 1 0 010 2H5v7h2l1 2h4l1-2h2V5h-1a1 1 0 110-2h1a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5z"></path></svg>
              <span className={expand ? "flex-1 ml-3 whitespace-nowrap" : "hidden"}>
                Inbox
              </span>
