...
const NavBarFlow = () => {
  ...
  const handleDropClick = () => {
    ...
    setStyle({ position: 'absolute', inset: '0px auto auto 0px', margin: '0px', transform: `translate3d(${pos > 124 ? pos - 124 : 0}px, 60px, 0px)` })
    setDrop(!drop)
  }
      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="flex md:order-2 items-center">
          ...
          <button
            ...
            type="button" className="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300" >
          ...
          <button
            ...
            type="button" className="inline-flex items-center p-2 text-sm text-light-1 rounded-lg md:hidden hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-4" aria-expanded="false">
