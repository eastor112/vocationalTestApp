    ...
    <section className='summary mt-6 bg-secondary-1 md:flex md:items-center relative md:h-80'>
      ...
      <div className='md:flex md:w-1/2 md:h-80 h-full overflow-hidden'>
        <img
          ...
          src={require('./../../../assets/lawer-career.jpg')} alt=""
        />
      </div>
      ...
      <div className='md:h-80  md:flex md:flex-col justify-between md:w-1/2 px-4 py-3 md:px-5 lg:px-7 xl:px-8'>
        ...
        <ul className='my-4'>
          <li className='list-disc ml-4 mb-3 text-sm lg:text-base xl:text-lg '>
            <span className='font-bold text-base lg:text-lg'>Employment field:</span> Activities of representation, forensic practice, judge.
          </li>
          <li className='list-disc ml-4 mb-3 text-sm lg:text-base xl:text-lg '>
            <span className='font-bold text-base lg:text-lg'>Average monthly salary:</span> 550.5 USD
          </li>
          <li className='list-disc ml-4 mb-3 text-sm lg:text-base xl:text-lg '>
            <span className='font-bold text-base lg:text-lg'>Principal required skill:</span>  Capacity for analysis and interpretation. Ethical vocation and commitment to justice.
          </li>
        </ul>
      </div>
