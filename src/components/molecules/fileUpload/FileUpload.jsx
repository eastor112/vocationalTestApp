...
const FileUpload = () => {
  return (
    <>
      ...
      <input className='block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer focus:outline-none focus:border-transparent ' aria-describedby='user_avatar_help' id='user_avatar' type='file' />
