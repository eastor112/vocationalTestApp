      ...
      <section className='flex flex-col lg:flex-row gap-8 lg:gap-16'>
        ...
        <div className='flex-1 flex items-center h-64 border border-primary-1 overflow-hidden rounded-lg shadow-lg bg-white'>
          ...
          <div className='flex-1 p-5 flex flex-col items-center'>
            ...
            <Link to='/dashboard/test' className='text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-md text-sm px-5 py-2.5 text-center mr-2 mb-2'>
              Go to the test
            </Link>
